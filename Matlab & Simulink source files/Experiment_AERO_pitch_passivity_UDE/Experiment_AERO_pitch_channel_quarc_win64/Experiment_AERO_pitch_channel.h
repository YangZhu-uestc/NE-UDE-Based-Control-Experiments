...
typedef struct {
  ...
  real_T Gain_a[3];                    /* '<S6>/Gain' */
  real_T Gain_j[3];                    /* '<S4>/Gain' */
  real_T Gain_h;                       /* '<S5>/Gain' */
  real_T Gain2;                        /* '<Root>/Gain2' */
  real_T theta_dot;                    /* '<S2>/theta_dot' */
  real_T Gain2_p;                      /* '<S2>/Gain2' */
  real_T psi_dot;                      /* '<S2>/psi_dot' */
  real_T Gain7;                        /* '<S2>/Gain7' */
  real_T TransferFcn3;                 /* '<S9>/Transfer Fcn3' */
  real_T theta_d;                      /* '<S8>/MATLAB Function1' */
  real_T omega_d;                      /* '<S8>/MATLAB Function1' */
  real_T zd_dot[2];                    /* '<S8>/MATLAB Function' */
...
typedef struct {
  ...
  real_T TransferFcn2_CSTATE[2];       /* '<S9>/Transfer Fcn2' */
  real_T TransferFcn5_CSTATE;          /* '<S9>/Transfer Fcn5' */
  real_T theta_CSTATE;                 /* '<S2>/theta' */
  real_T theta_dot_CSTATE;             /* '<S2>/theta_dot' */
  real_T psi_dot_CSTATE;               /* '<S2>/psi_dot' */
  real_T psi_CSTATE;                   /* '<S2>/psi' */
  real_T TransferFcn3_CSTATE;          /* '<S9>/Transfer Fcn3' */
...
typedef struct {
  ...
  boolean_T TransferFcn2_CSTATE[2];    /* '<S9>/Transfer Fcn2' */
  boolean_T TransferFcn5_CSTATE;       /* '<S9>/Transfer Fcn5' */
  ...
  boolean_T TransferFcn3_CSTATE;       /* '<S9>/Transfer Fcn3' */
...
struct P_Experiment_AERO_pitch_chann_T_ {
  ...
  real_T LPF5_C;                       /* Computed Parameter: LPF5_C
                                        * Referenced by: '<Root>/LPF5'
                                        */
  real_T passivefilter_A;              /* Computed Parameter: passivefilter_A
                                        * Referenced by: '<Root>/passive filter'
                                        */
  real_T passivefilter_C;              /* Computed Parameter: passivefilter_C
                                        * Referenced by: '<Root>/passive filter'
                                        */
 ...
 * '<S2>'   : 'Experiment_AERO_pitch_channel/Quanser AERO Model'
 * '<S3>'   : 'Experiment_AERO_pitch_channel/Quanser Aero USB Interface'
 * '<S4>'   : 'Experiment_AERO_pitch_channel/Radians to Degrees10'
 * '<S5>'   : 'Experiment_AERO_pitch_channel/Radians to Degrees2'
 * '<S6>'   : 'Experiment_AERO_pitch_channel/Radians to Degrees4'
 * '<S7>'   : 'Experiment_AERO_pitch_channel/Radians to Degrees5'
 * '<S8>'   : 'Experiment_AERO_pitch_channel/Ref for AERO 0.2-0.2cost'
 * '<S9>'   : 'Experiment_AERO_pitch_channel/passivity_UDE'
 * '<S10>'  : 'Experiment_AERO_pitch_channel/Quanser Aero USB Interface/Base LED Colour'
 * '<S11>'  : 'Experiment_AERO_pitch_channel/Ref for AERO 0.2-0.2cost/Degrees to Radians1'
 * '<S12>'  : 'Experiment_AERO_pitch_channel/Ref for AERO 0.2-0.2cost/MATLAB Function'
 * '<S13>'  : 'Experiment_AERO_pitch_channel/Ref for AERO 0.2-0.2cost/MATLAB Function1'
 */
