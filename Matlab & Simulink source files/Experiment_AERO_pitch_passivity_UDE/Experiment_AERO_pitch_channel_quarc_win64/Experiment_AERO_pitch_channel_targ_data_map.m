  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% Experiment_AERO_pitch_channel_P.TransferFcn_A
	  ...
	  ;% Experiment_AERO_pitch_channel_P.TransferFcn1_A
	  ...
	  ;% Experiment_AERO_pitch_channel_P.TransferFcn2_A
	  section.data(46).logicalSrcIdx = 72;
	  section.data(46).dtTransOffset = 54;
	
	  ;% Experiment_AERO_pitch_channel_P.TransferFcn2_C
	  section.data(47).logicalSrcIdx = 73;
	  section.data(47).dtTransOffset = 56;
	
	  ;% Experiment_AERO_pitch_channel_P.TransferFcn5_A
	  ...
	  ;% Experiment_AERO_pitch_channel_P.TransferFcn3_A
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% Experiment_AERO_pitch_channe_DW.Integrator_IWORK
  ...
  targMap.checksum0 = 4207483034;
  targMap.checksum1 = 2412855801;
  targMap.checksum2 = 4041650528;
  targMap.checksum3 = 868436722;
