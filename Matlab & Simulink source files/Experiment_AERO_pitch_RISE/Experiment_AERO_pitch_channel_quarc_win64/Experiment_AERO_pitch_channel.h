...
typedef struct {
  ...
  real_T z1_dot;                       /* '<Root>/z' */
  real_T z2_dot;                       /* '<Root>/z' */
  real_T v;                            /* '<Root>/virtual control' */
  real_T w1;                           /* '<Root>/parameter' */
  real_T h2;                           /* '<Root>/parameter' */
  real_T h3;                           /* '<Root>/parameter' */
  real_T h4;                           /* '<Root>/parameter' */
  real_T theta_d;                      /* '<S9>/MATLAB Function1' */
  real_T omega_d;                      /* '<S9>/MATLAB Function1' */
  real_T zd_dot[2];                    /* '<S9>/MATLAB Function' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } erroscope_PWORK;                   /* '<Root>/erroscope' */
...
struct P_Experiment_AERO_pitch_chann_T_ {
  ...
  real_T zd_IC[2];                     /* Expression: [0;0]
                                        * Referenced by: '<S9>/zd'
                                        */
  real_T k0_Value;                     /* Expression: 0.3
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        ...
                                        */
  real_T k2_Value;                     /* Expression: 20
                                        * Referenced by: '<Root>/k2'
                                        */
  real_T k1_Value;                     /* Expression: 0.2
 ...
 * '<S1>'   : 'Experiment_AERO_pitch_channel/F_hat'
 ...
 * '<S9>'   : 'Experiment_AERO_pitch_channel/Ref for AERO 0.2+0.2sint'
 * '<S10>'  : 'Experiment_AERO_pitch_channel/control law'
 * '<S11>'  : 'Experiment_AERO_pitch_channel/parameter'
 * '<S12>'  : 'Experiment_AERO_pitch_channel/rf'
 * '<S13>'  : 'Experiment_AERO_pitch_channel/virtual control'
 * '<S14>'  : 'Experiment_AERO_pitch_channel/xi'
 * '<S15>'  : 'Experiment_AERO_pitch_channel/z'
 * '<S16>'  : 'Experiment_AERO_pitch_channel/Quanser Aero USB Interface/Base LED Colour'
 * '<S17>'  : 'Experiment_AERO_pitch_channel/Ref for AERO 0.2+0.2sint/Degrees to Radians1'
 * '<S18>'  : 'Experiment_AERO_pitch_channel/Ref for AERO 0.2+0.2sint/MATLAB Function'
 * '<S19>'  : 'Experiment_AERO_pitch_channel/Ref for AERO 0.2+0.2sint/MATLAB Function1'
 */
