  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% Experiment_AERO_pitch_channel_P.feedback6_Gain
	  ...
	  ;% Experiment_AERO_pitch_channel_P.u_Value
	  ...
	  ;% Experiment_AERO_pitch_channel_P.TF4_A
	  ...
	  ;% Experiment_AERO_pitch_channel_P.TF5_A
	  ...
	  ;% Experiment_AERO_pitch_channel_P.u_Value_f
	  section.data(55).logicalSrcIdx = 83;
	  section.data(55).dtTransOffset = 65;
	
	  ;% Experiment_AERO_pitch_channel_P.TF1_A_b
	  ...
	  ;% Experiment_AERO_pitch_channel_P.Constant_Value_g
	  ...
	  ;% Experiment_AERO_pitch_channel_P.Constant_Value_g3
	  ...
	  ;% Experiment_AERO_pitch_channel_P.ManualSwitch14_CurrentSetting
	  section.data(2).logicalSrcIdx = 179;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Experiment_AERO_pitch_channel_P.ManualSwitch12_CurrentSetting
	  ...
	  ;% Experiment_AERO_pitch_channel_P.ManualSwitch3_CurrentSetting_c
	  ...
	  ;% Experiment_AERO_pitch_channel_P.ManualSwitch9_CurrentSetting
	  section.data(10).logicalSrcIdx = 187;
	  section.data(10).dtTransOffset = 9;
	
	  ;% Experiment_AERO_pitch_channel_P.ManualSwitch2_CurrentSetting_b
	  section.data(11).logicalSrcIdx = 188;
	  section.data(11).dtTransOffset = 10;
	
	  ;% Experiment_AERO_pitch_channel_P.ManualSwitch13_CurrentSetting
	  ...
	  section.data(20).dtTransOffset = 126;
	  ...
	  section.data(26).dtTransOffset = 217;
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% Experiment_AERO_pitch_channel_B.u0
	  section.data(7).logicalSrcIdx = 6;
	  ...
	  ;% Experiment_AERO_pitch_channel_B.u0d_hat
	  section.data(11).logicalSrcIdx = 10;
	  ...
	  ;% Experiment_AERO_pitch_channel_B.Gain_e
	  section.data(20).logicalSrcIdx = 19;
	  section.data(20).dtTransOffset = 21;
	  ...
	  ;% Experiment_AERO_pitch_channel_B.Sum_p
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% Experiment_AERO_pitch_channe_DW.d_hat_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 27;
	  section.data(11).dtTransOffset = 10;
	
	  ;% Experiment_AERO_pitch_channe_DW.d_hat_compare_PWORK.LoggedData
	  section.data(12).logicalSrcIdx = 28;
	  section.data(12).dtTransOffset = 11;
	
	  ;% Experiment_AERO_pitch_channe_DW.n_hat_PWORK.LoggedData
	  ...
	  ;% Experiment_AERO_pitch_channe_DW.u_PWORK.LoggedData
	  section.data(21).logicalSrcIdx = 37;
	  section.data(21).dtTransOffset = 20;
	
	  ;% Experiment_AERO_pitch_channe_DW.u0_PWORK.LoggedData
	  section.data(22).logicalSrcIdx = 38;
	  section.data(22).dtTransOffset = 21;
	
	  ;% Experiment_AERO_pitch_channe_DW.u01_PWORK.LoggedData
	  ...
	  ;% Experiment_AERO_pitch_channe_DW.theta_fb0_IWORK_c
	  section.data(2).logicalSrcIdx = 58;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Experiment_AERO_pitch_channe_DW.theta_fb0_IWORK_m
  ...
  targMap.checksum0 = 3320430816;
  targMap.checksum1 = 1305624298;
  targMap.checksum2 = 1076080333;
  targMap.checksum3 = 96581108;
