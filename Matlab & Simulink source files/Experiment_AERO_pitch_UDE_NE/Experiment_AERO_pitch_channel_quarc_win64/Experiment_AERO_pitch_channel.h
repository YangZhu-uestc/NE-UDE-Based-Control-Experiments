...
typedef struct {
  real_T GyroCalibration[3];           /* '<S4>/Gyro Calibration' */
  real_T Pitchcountstodeg;             /* '<S4>/Pitch: counts to deg' */
  real_T LPF3;                         /* '<Root>/LPF3' */
  real_T LPF2;                         /* '<Root>/LPF2' */
  real_T LPF1;                         /* '<Root>/LPF1' */
  real_T ManualSwitch11;               /* '<Root>/Manual Switch11' */
  real_T u0;                           /* '<S13>/Sum' */
  real_T Gain;                         /* '<S12>/Gain' */
  real_T theta_fb0;                    /* '<S11>/theta_fb(0)' */
  real_T Gain_m;                       /* '<S11>/Gain' */
  real_T u0d_hat;                      /* '<Root>/Sum3' */
  real_T theta_fb0_f;                  /* '<S2>/theta_fb(0)' */
  real_T Sum2;                         /* '<S2>/Sum2' */
  real_T u;                            /* '<Root>/ 5' */
  real_T ManualSwitch13;               /* '<Root>/Manual Switch13' */
  real_T Switch;                       /* '<S1>/Switch' */
  real_T u_g;                          /* '<Root>/ ' */
  real_T PitchaxisEnable;              /* '<S3>/Pitch axis Enable' */
  real_T YawaxisEnable;                /* '<S3>/Yaw axis Enable' */
  real_T Gain_e;                       /* '<S10>/Gain' */
  real_T Sum4;                         /* '<Root>/Sum4' */
  real_T Sum2_c;                       /* '<Root>/Sum2' */
  real_T Gain_l;                       /* '<S9>/Gain' */
  real_T Gain_a[3];                    /* '<S7>/Gain' */
  real_T Gain_j[3];                    /* '<S5>/Gain' */
  real_T Gain_h;                       /* '<S6>/Gain' */
  real_T theta_dot;                    /* '<S3>/theta_dot' */
  real_T Gain2;                        /* '<S3>/Gain2' */
  real_T psi_dot;                      /* '<S3>/psi_dot' */
  real_T Gain7;                        /* '<S3>/Gain7' */
  real_T Sum;                          /* '<S11>/Sum' */
  real_T Sum_p;                        /* '<S12>/Sum' */
  real_T theta_d;                      /* '<S10>/MATLAB Function1' */
  real_T omega_d;                      /* '<S10>/MATLAB Function1' */
  real_T zd_dot[2];                    /* '<S10>/MATLAB Function' */
...
typedef struct {
  ...
  real_T HILInitialize_FilterFrequency[4];/* '<S4>/HIL Initialize' */
  real_T HILRead_AnalogBuffer[2];      /* '<S4>/HIL Read' */
  real_T HILRead_OtherBuffer[8];       /* '<S4>/HIL Read' */
  real_T HILWrite_AnalogBuffer[2];     /* '<S4>/HIL Write' */
  real_T HILWrite_OtherBuffer[3];      /* '<S4>/HIL Write' */
  ...
  struct {
    void *LoggedData;
  } d_hat_PWORK;                       /* '<Root>/d_hat' */

  struct {
    void *LoggedData;
  } d_hat_compare_PWORK;               /* '<Root>/d_hat_compare' */

  struct {
    void *LoggedData;
  } n_hat_PWORK;                       /* '<Root>/n_hat' */
  ...
  int32_T HILInitialize_DOStates[2];   /* '<S4>/HIL Initialize' */
  int32_T HILInitialize_QuadratureModes[4];/* '<S4>/HIL Initialize' */
  int32_T HILInitialize_InitialEICounts[4];/* '<S4>/HIL Initialize' */
  int32_T HILRead_EncoderBuffer[2];    /* '<S4>/HIL Read' */
  ...
  int_T theta_fb0_IWORK;               /* '<S12>/theta_fb(0)' */
  int_T theta_fb0_IWORK_c;             /* '<S11>/theta_fb(0)' */
  int_T theta_fb0_IWORK_m;             /* '<S2>/theta_fb(0)' */
  boolean_T HILInitialize_DOBits[2];   /* '<S4>/HIL Initialize' */
  t_boolean HILRead_DigitalBuffer[3];  /* '<S4>/HIL Read' */
  t_boolean HILWrite_DigitalBuffer[2]; /* '<S4>/HIL Write' */
} DW_Experiment_AERO_pitch_chan_T;

/* Continuous states (default storage) */
typedef struct {
  real_T LPF3_CSTATE;                  /* '<Root>/LPF3' */
  real_T LPF2_CSTATE;                  /* '<Root>/LPF2' */
  real_T LPF1_CSTATE;                  /* '<Root>/LPF1' */
  real_T zd_CSTATE[2];                 /* '<S10>/zd' */
  ...
  real_T theta_fb0_CSTATE;             /* '<S12>/theta_fb(0)' */
  real_T Integrator2_CSTATE;           /* '<S12>/Integrator2' */
  real_T TF1_CSTATE[2];                /* '<S11>/TF1' */
  real_T Integrator1_CSTATE_d;         /* '<S11>/Integrator1' */
  real_T TF4_CSTATE;                   /* '<S11>/TF4' */
  real_T theta_fb0_CSTATE_p;           /* '<S11>/theta_fb(0)' */
  real_T TF5_CSTATE;                   /* '<S11>/TF5' */
  real_T Integrator2_CSTATE_e;         /* '<S11>/Integrator2' */
  real_T TF1_CSTATE_a;                 /* '<S2>/TF1' */
  real_T theta_fb0_CSTATE_c;           /* '<S2>/theta_fb(0)' */
  real_T TF3_CSTATE;                   /* '<S2>/TF3' */
  real_T TF2_CSTATE;                   /* '<S2>/TF2' */
  real_T theta_CSTATE;                 /* '<S3>/theta' */
  real_T theta_dot_CSTATE;             /* '<S3>/theta_dot' */
  real_T psi_dot_CSTATE;               /* '<S3>/psi_dot' */
  real_T psi_CSTATE;                   /* '<S3>/psi' */
...
/* State disabled  */
typedef struct {
  boolean_T LPF3_CSTATE;               /* '<Root>/LPF3' */
  boolean_T LPF2_CSTATE;               /* '<Root>/LPF2' */
  boolean_T LPF1_CSTATE;               /* '<Root>/LPF1' */
  boolean_T zd_CSTATE[2];              /* '<S10>/zd' */
  ...
  boolean_T theta_fb0_CSTATE;          /* '<S12>/theta_fb(0)' */
  boolean_T Integrator2_CSTATE;        /* '<S12>/Integrator2' */
  boolean_T TF1_CSTATE[2];             /* '<S11>/TF1' */
  boolean_T Integrator1_CSTATE_d;      /* '<S11>/Integrator1' */
  boolean_T TF4_CSTATE;                /* '<S11>/TF4' */
  boolean_T theta_fb0_CSTATE_p;        /* '<S11>/theta_fb(0)' */
  boolean_T TF5_CSTATE;                /* '<S11>/TF5' */
  boolean_T Integrator2_CSTATE_e;      /* '<S11>/Integrator2' */
  boolean_T TF1_CSTATE_a;              /* '<S2>/TF1' */
  boolean_T theta_fb0_CSTATE_c;        /* '<S2>/theta_fb(0)' */
  boolean_T TF3_CSTATE;                /* '<S2>/TF3' */
  boolean_T TF2_CSTATE;                /* '<S2>/TF2' */
  boolean_T theta_CSTATE;              /* '<S3>/theta' */
  boolean_T theta_dot_CSTATE;          /* '<S3>/theta_dot' */
  boolean_T psi_dot_CSTATE;            /* '<S3>/psi_dot' */
  boolean_T psi_CSTATE;                /* '<S3>/psi' */
...
struct P_Experiment_AERO_pitch_chann_T_ {
  ...
  real_T p1_Value;                     /* Expression: -1.635e+07
                                        * Referenced by: '<S1>/p1'
                                        */
  real_T LPF3_A;                       /* Computed Parameter: LPF3_A
                                        * Referenced by: '<Root>/LPF3'
                                        */
  real_T LPF3_C;                       /* Computed Parameter: LPF3_C
                                        * Referenced by: '<Root>/LPF3'
                                        */
  real_T LPF2_A;                       /* Computed Parameter: LPF2_A
                                        * Referenced by: '<Root>/LPF2'
                                        */
  real_T LPF2_C;                       /* Computed Parameter: LPF2_C
                                        * Referenced by: '<Root>/LPF2'
                                        */
  ...
  real_T zd_IC[2];                     /* Expression: [0;0]
                                        ...
                                        */
  real_T feedback6_Gain;               /* Expression: 1
  ...
  real_T LPF5_C;                       /* Computed Parameter: LPF5_C
                                        * Referenced by: '<Root>/LPF5'
                                        */
  real_T feedback4_Gain;               /* Expression: 1
                                        * Referenced by: '<Root>/ feedback?4'
                                        */
  real_T feedback5_Gain;               /* Expression: 1
  ...
  real_T Integrator2_IC;               /* Expression: 0
                                        ...
                                        */
  real_T TF1_A[2];                     /* Computed Parameter: TF1_A
                                        * Referenced by: '<S11>/TF1'
                                        */
  real_T TF1_C[2];                     /* Computed Parameter: TF1_C
                                        * Referenced by: '<S11>/TF1'
                                        */
  real_T Integrator1_IC_n;             /* Expression: 0
                                        * Referenced by: '<S11>/Integrator1'
                                        */
  real_T TF4_A;                        /* Computed Parameter: TF4_A
                                        * Referenced by: '<S11>/TF4'
                                        */
  real_T TF4_C;                        /* Computed Parameter: TF4_C
                                        * Referenced by: '<S11>/TF4'
                                        */
  real_T TF4_D;                        /* Computed Parameter: TF4_D
                                        * Referenced by: '<S11>/TF4'
                                        */
  real_T TF5_A;                        /* Computed Parameter: TF5_A
                                        * Referenced by: '<S11>/TF5'
                                        */
  real_T TF5_C;                        /* Computed Parameter: TF5_C
                                        * Referenced by: '<S11>/TF5'
                                        */
  real_T TF5_D;                        /* Computed Parameter: TF5_D
                                        * Referenced by: '<S11>/TF5'
                                        */
  ...
  real_T u_Value_f;                    /* Expression: 0
                                        ...
                                        */
  real_T TF1_A_b;                      /* Computed Parameter: TF1_A_b
                                        * Referenced by: '<S2>/TF1'
                                        */
  real_T TF1_C_p;                      /* Computed Parameter: TF1_C_p
                                        * Referenced by: '<S2>/TF1'
                                        */
  ...
  uint8_T ManualSwitch1_CurrentSetting;/* Computed Parameter: ManualSwitch1_CurrentSetting
                                        ...
                                        */
  uint8_T ManualSwitch3_CurrentSetting_c;/* Computed Parameter: ManualSwitch3_CurrentSetting_c
  ...
  uint8_T ToHostFile2_FileFormat;      /* Computed Parameter: ToHostFile2_FileFormat
                                        * Referenced by: '<Root>/To Host File2'
                                        */
  uint8_T ToHostFile3_file_name[32];   /* Expression: file_name_argument
                                        * Referenced by: '<Root>/To Host File3'
                                        */
  uint8_T ToHostFile3_VarName[28];     /* Expression: variable_name_argument
                                        * Referenced by: '<Root>/To Host File3'
                                        */
 ...
 * '<S1>'   : 'Experiment_AERO_pitch_channel/Motor Model (Tao2V & voltage saturation)'
 * '<S2>'   : 'Experiment_AERO_pitch_channel/NE'
 * '<S3>'   : 'Experiment_AERO_pitch_channel/Quanser AERO Model'
 * '<S4>'   : 'Experiment_AERO_pitch_channel/Quanser Aero USB Interface'
 * '<S5>'   : 'Experiment_AERO_pitch_channel/Radians to Degrees10'
 * '<S6>'   : 'Experiment_AERO_pitch_channel/Radians to Degrees2'
 * '<S7>'   : 'Experiment_AERO_pitch_channel/Radians to Degrees4'
 * '<S8>'   : 'Experiment_AERO_pitch_channel/Radians to Degrees5'
 * '<S9>'   : 'Experiment_AERO_pitch_channel/Radians to Degrees6'
 * '<S10>'  : 'Experiment_AERO_pitch_channel/Ref for AERO 0.2+0.2sint'
 * '<S11>'  : 'Experiment_AERO_pitch_channel/UDE'
 * '<S12>'  : 'Experiment_AERO_pitch_channel/classic UDE'
 * '<S13>'  : 'Experiment_AERO_pitch_channel/ud+kp*theta_tiltde+kd*omega_tiltde'
 * '<S14>'  : 'Experiment_AERO_pitch_channel/Quanser Aero USB Interface/Base LED Colour'
 * '<S15>'  : 'Experiment_AERO_pitch_channel/Ref for AERO 0.2+0.2sint/Degrees to Radians1'
 * '<S16>'  : 'Experiment_AERO_pitch_channel/Ref for AERO 0.2+0.2sint/MATLAB Function'
 * '<S17>'  : 'Experiment_AERO_pitch_channel/Ref for AERO 0.2+0.2sint/MATLAB Function1'
 */
